...
from VampireMusic.utils.decorators.admins import ActualAdminCB
from VampireMusic.utils.decorators.language import language, languageCB
from VampireMusic.utils.inline.settings import (
    auth_users_markup,
    playmode_users_markup,
    setting_markup,
    vote_mode_markup,
)
from VampireMusic.utils.inline.start import private_panel
...
async def settings_back_markup(client, CallbackQuery: CallbackQuery, _):
    ...
    if CallbackQuery.message.chat.type == ChatType.PRIVATE:
        ...
        return await CallbackQuery.edit_message_media(
            InputMediaPhoto(
                media=random.choice(Vampire_PIC),
                has_spoiler=True,
