...
This document describes all configuration variables used in KanhaMusic. These can be set as environment variables or in a `.env` file in the project root.
...
| Variable | Default | Description |
| :--- | :--- | :--- |
| `DEFAULT_LANG` | `en` | Default language for bot responses (see `kanha/locales/`). |
